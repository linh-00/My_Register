...
namespace Inc.MyRegister.Application.UseCase.RegistroPontos
{
    public class GetRegistroPontoByEmpresaUseCase : IGetRegistroPontoByEmpresaUseCase
    {
        ...
        public  GetRegistroPontoByEmpresaUseCase(IMapper mapper, ILogger<GetRegistroPontoByEmpresaUseCase> logger, IRegistroPontosRepository registroPontosRepository)
        {
            _Logger = logger;
            _Mapper = mapper;
